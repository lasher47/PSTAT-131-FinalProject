...
```
Our testing accuracy is about 0.738 which is about the same value that we obtained from the training data.
...
Now we can use this model to make some predictions on some in-game data that I've sourced from profession games
...
From our analysis above, our model has a reasonable chance of predicting the winner from the earlygame, but not quite high enough to make surefire predictions. The average game length for most League of Legends games is typically under 30 minutes. 10 minutes of the earlygame is only about a third of the game, which still leaves plenty of time for the losing team to come back. 
