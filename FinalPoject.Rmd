...
Our accuracy from this simplified model is only 0.55, marginally better than a coin flip. To better explore the properties of the ward variables, let's plot some boxplots of them to get a sense of the distribution.
...
We will start splitting our data into training and testing splits, with an initial split of 80/20 training/testing. We also do not need to stratify our data because our dataset actually has a very balanced outcome variable distribution. 
...
We will also use K-fold cross validation to improve our model's performance 
